...
const NuevaCuenta = (props) => {
    ...
    // En caso de que el usuario se haya registrado ,autenticado o sea un registro duplicado
    useEffect(() => {
    ...
    // STATE DE USUARIO
    const [cuentaNueva, guardarCuentaNueva] = useState({
        nombre:'',
        email:'',
        password:'',
        confirmarPassword:''
    ...
    const {nombre,email, password, confirmarPassword} = cuentaNueva;
